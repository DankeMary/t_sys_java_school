            ...
            <div class="col-12" style="overflow:auto">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <div style="display:inline-block; margin-right: 15px;"><b>Capacity
                            :</b> ${trainData.trainBean.capacity}
                        </div>
                        <div style="display:inline-block; margin-right: 15px;"><b>Price
                            :</b> ${trainData.trainBean.price}</div>
                        ...
                        <p><b>Journeys : </b> <a href="/worker/trains/${trainData.trainBean.id}/journeys">See
                            More...</a></p>
                        <h5>Train Path:</h5>
